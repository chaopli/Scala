object session {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(23); val res$0 = 
	...
	def isGoodEnough(guess: Double, x: Double) =
		abs(guess * guess - x) / x < 0.01;System.out.println("""isGoodEnough: (guess: Double, x: Double)Boolean""");$skip(70); 
	...
	sqrt(1e-6);System.out.println("""res4: Double = """ + $show(res$4))}
}
